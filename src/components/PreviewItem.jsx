...
export default function PreviewItem({ items, handleTitleChange, copyToClipboard, ...props }) {
                ...
                <div className="position-relative z-1">
                    <div className="preview-item-actions position-absolute top-0 end-0 z-2">
                        <div className='d-flex align-items-center gap-2'>
                            <a href='#' onClick={() => copyToClipboard(item.paste)} className='border-0 p-0 d-flex align-items-center justify-content-center'>
