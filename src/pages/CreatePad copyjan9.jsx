...
files.forEach((file, index) => {
      ...
      formData.append('expiry_date', newDateFormatted); // Example date
      formData.append('burn_after_read', burnAfterRead);   // Example value
              ...
              <div className="doc-modal-uploading d-flex gap-3 flex-wrap align-items-center justify-content-between">
                ...
                <div className="right d-grid align-items-center gap-2">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <h6 className="mb-0 pl-1">eu store {progress[file.name]?.loaded || 0}</h6>
                  </div>
                  <div className="d-flex align-items-center gap-2">
                    <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
