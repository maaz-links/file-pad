...
export default function CreatePad() {
  ...
  const { burnAfterRead, expiryDateIncrement } = useOutletContext();
  ...
  const handleSubmit = async (event) => {
    ...
    // Create a new FormData instance to append form data and files
    const formData = new FormData();
    for (let i = 0; i < files.length; i++) {
      formData.append('filesupload[]', files[i]);
    }
    console.log(newDateFormatted);
    console.log(burnAfterRead);
            ...
            <div className="doc-modal-body">
              <div className="doc-modal-uploading d-flex gap-3 flex-wrap align-items-center justify-content-between">
                <div className="left d-flex align-items-center gap-2">
                  ...
                  <div className="ps-1">
                    <h6 className='mb-0 lh-base text-uppercase'>VO Final edit.mp3</h6>
                    <p className='text-uppercase lh-base'>7.2 MB</p>
                  </div>
                </div>
                <div className="right d-grid align-items-center gap-2">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <h6 className="mb-0 pl-1">eu store 2</h6>
                  </div>
                  <div className="d-flex align-items-center gap-2">
                    <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h6 className="mb-0 pl-1">303.2 KB/s</h6>
                  </div>
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <h6 className="mb-0 pl-1">00:00:22</h6>
                  </div>
